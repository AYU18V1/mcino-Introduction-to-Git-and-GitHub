...
const localSongs = [
    { path: 'assets/Songs/Motivational Energy/BrothersAnthem.mp3', title: 'Brother Anthem', artist: 'Vishal Dadlani' },
    { path: 'assets/Songs/Motivational Energy/RangDe.mp3', title: 'Khoon Chala Rang De Basanti', artist: 'Mohit Chauhan' },
	{ path: 'assets/Songs/Motivational Energy/Time.mp3', title: '	Apna Time Aayega', artist: 'Divine and Ranveer Singh' }
];
