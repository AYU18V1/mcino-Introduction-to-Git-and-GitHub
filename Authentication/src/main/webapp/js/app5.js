...
const localSongs = [
    { path: 'assets/Songs/Melancholy Feels/AgarTumSaathHo.mp3', title: 'Agar Tum Saath Ho', artist: 'Alka Yagnik and Arijit Singh' },
    { path: 'assets/Songs/Melancholy Feels/ChannaMereya.mp3', title: 'Channa Mereya', artist: 'Arjit Singh' },
	{ path: 'assets/Songs/Melancholy Feels/Duaa.mp3', title: 'Duaa', artist: 'Shanghai' }
];
