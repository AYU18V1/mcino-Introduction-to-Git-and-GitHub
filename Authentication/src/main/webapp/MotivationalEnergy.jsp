                ...
                <div class="playlist"style = "width : 130% ; height : 100%">
                    <div class="genres"  >
                        <div class="header">
                            ...
                            <h4>Motivational Energy</h4>
                        </div>

                        <div class="items" >
                            <div class="item"  onclick="playSongByDetails('assets/Songs/Motivational Energy/BrothersAnthem.mp3', 'Brother Anthem', 'Vishal Dadlani')">
                                <p>Brother Anthem</p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Motivational Energy/RangDe.mp3', 'Khoon Chala Rang De Basanti', 'Mohit Chauhan')">
                                <p>Khoon Chala Rang De Basanti </p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Motivational Energy/Time.mp3', 'Apna Time Aayega', 'Divine and Ranveer Singh')">
                                <p>Apna Time Aega</p>
                            </div>
