            ...
            <div class="music-list">
                <div class="playlist"style = "width : 130% ; height : 100%">
                    <div class="genres"  >
                        ...
                        <div class="items" >
                            <div class="item"  onclick="playSongByDetails('assets/Songs/Calm Moments/Kabira.mp3', 'Kabira', 'Pritam')">
                                <p>Kabira</p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Calm Moments/MaanMeriJaan.mp3', 'Maan Meri Jaan', 'King')">
                                <p>Maan Meri Jaan </p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Calm Moments/TumHiHo.mp3', 'tum Hi Ho', 'Arjit Singh')">
                                <p>Tum Hi Ho</p>
                            </div>
