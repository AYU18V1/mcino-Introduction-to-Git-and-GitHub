        ...
        <div class ="sidebarStick" style="position: fixed; ">
            ...
            <div class="menu">
                    ...
                    <div class="items">
                        ...
                        <div class="item">
                         <a href="Love.jsp"><p>Love &<br>Romance</p></a> 
            ...
            <div class="music-list">
                <div class="playlist"style = "width : 130% ; height : 100%">
                    <div class="genres"  >
                        ...
                        <div class="items" >
                            <div class="item"  onclick="playSongByDetails('assets/Songs/Classical Period/JeeneLagaHoon.mp3', 'Jeene Laga Hoon', 'Atif Aslam, Shreya Ghoshal')">
                                <p>Jeene Laga Hoon</p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Classical Period/PeeLoon.mp3', 'Pee Loon', 'Mohit Chauhan')">
                                <p>Pee Loon</p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Classical Period/Pal.mp3', 'Pal', 'Arijit Singh')">
                                <p>Pal</p>
                            </div>
                             <div class="item" onclick="playSongByDetails('assets/Songs/Classical Period/Raabta.mp3', 'Raabta', ' Arijit Singh')">
                                <p>Raabta</p>
                            </div>
