            ...
            <div class="music-list">
                <div class="playlist"style = "width : 130% ; height : 100%">
                    <div class="genres"  >
                        ...
                        <div class="items" >
                            <div class="item"  onclick="playSongByDetails('assets/Songs/Happy Vibes/Bom Diggy Diggy.mp3', 'Bom Diggy Diggy', 'Guru Randhwa')">
                                <p>Bom Diggy Diggy</p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Happy Vibes/LOVER .mp3', 'Lover', 'Diljit Dosanjh')">
                                <p>Lover</p>
                            </div>
                            <div class="item" onclick="playSongByDetails('assets/Songs/Happy Vibes/Ghungroo.mp3', 'Ghungroo', 'Arjit Singh,Shilpa_Vishal')">
                                <p>Ghungroo</p>
                            </div>
                             <div class="item" onclick="playSongByDetails('assets/Songs/Happy Vibes/AankhMarey.mp3', 'Aankh Marey', 'Tanishk Bagchi,MikaSingh')">
